...
import { Mic, MicOff, Volume2, Home, Trophy, CheckCircle, XCircle, RefreshCw } from "lucide-react";
    ...
    return (
      <div className="min-h-screen p-4">
        <div className="max-w-2xl mx-auto py-8">
          <h1 className="text-3xl font-bold text-center mb-8">🎤 Speaking Practice</h1>
          <p className="text-center text-gray-600 dark:text-gray-300 mb-8">Escucha y repite la frase en inglés</p>
