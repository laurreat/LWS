...
async function seedA1Modules() {
  console.log('Seeding A1 modules...')
  ...
  if (error) console.error('Error seeding A1 modules:', error)
  else console.log('A1 modules seeded successfully!')
}

async function seedA2Modules() {
  console.log('Seeding A2 modules...')
  ...
  const { error } = await supabase.from('modules').upsert(modules)
  if (error) console.error('Error seeding A2 modules:', error)
  else console.log('A2 modules seeded successfully!')
}

async function seedB1Modules() {
  console.log('Seeding B1 modules...')
  ...
  const { error } = await supabase.from('modules').upsert(modules)
  if (error) console.error('Error seeding B1 modules:', error)
  else console.log('B1 modules seeded successfully!')
}
